...
/***/ (function(module, exports, __webpack_require__) {
	...
	*/
	...
	$(function () {
		...
		var Masterscope = function Masterscope(params) {
			...
			self.model = {
				templates: {
					field: function field(params) {
						var returnString = '<div class="tile">' + params.label + ': ' + params.field;
						return returnString;
					},
					objectViewer: function objectViewer(params) {
						var returnString = '<div class = "tile">' + params.objectName + ': ' + params.content;
						return returnString;
					}
				},
				insertionPoints: {
	   ...
	   */
			...
			self.controller = {
				render: function render(params) {
					...
					$(target).append(self.model.templates.objectViewer({
